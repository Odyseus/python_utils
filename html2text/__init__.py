...
class HTML2Text(html.parser.HTMLParser):
    def __init__(
        ...
        self.ul_item_mark = config.UL_ITEM_MARK  # covered in cli
        self.emphasis_mark = config.EMPHASIS_MARK  # covered in cli
        self.strong_mark = config.STRONG_MARK  # covered in cli
