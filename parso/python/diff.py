...
from .tree import EndMarker
from .tokenize import PythonToken, BOM_UTF8_STRING
from .token import PythonTokenTypes
...
def _get_debug_error_message(module, old_lines, new_lines):
    ...
    return (
        ...
        % (__version__, ''.join(old_new_diff), ''.join(current_diff))
    )
